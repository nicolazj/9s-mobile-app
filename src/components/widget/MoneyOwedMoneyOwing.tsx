...
export class MoneyOwedMoneyOwing extends LineWidget {
  render() {
    ...
    return (
      <View>
        <Header>
          <IndexTitles>
            <IndexTitle>We owe</IndexTitle>
            <IndexTitle>Owed to us</IndexTitle>
          </IndexTitles>
          <IndexVals>
...
export default withTheme(MoneyOwedMoneyOwing);
