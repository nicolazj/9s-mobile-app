...
import { AuthResp, SignInPayload, UserAuthResp } from '../types';
...
const { tenantId, appKey, appSecret, device_id, baseURL } = config;

const instance = axios({
  baseURL: `${baseURL}/authentication/tenants/${tenantId}`,
  auth: {
    username: appKey,
    password: appSecret,
  },
